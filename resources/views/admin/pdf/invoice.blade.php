                  ...
                  <div class="p-5 osahan-invoice bg-white shadow-sm">
                     <div class="row">
                     	<div class="col-md-4">
                           ...
                           <p class="mb-1">Order placed at: <strong>{{showDate($result->order_date  ?? '' )}}</strong></p>
                           <p class="mb-4 mt-2">
                              ...
                              <tbody>
                                ...
                                @foreach($result->orderItems as $key => $orderItems)
                                 <tr>
                                    ...
                                    <td class="text-right">{{$orderItems->total_amount}} INR</td>
                                 </tr>
                                 @endforeach
                                 <tr>
                                    <td class="text-right" colspan="2">Item Total:</td>
                                    <td class="text-right">{{$result->total_amount}} INR</td>
                                 </tr>
                                 @endif
                              </tbody>
                           </table>
