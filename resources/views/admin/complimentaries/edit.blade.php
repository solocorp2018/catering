                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="{{route('complimentaries.update',$result->id)}}" enctype="multipart/form-data" method="post">
                                        {{csrf_field()}}
                                        @method('PUT')
                                        ...
                                        <div class="row pt-3">
                                            <div class="form-group col-sm-6 col-xs-6">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Enter Complimentary Name" value="{{old('name',$result->name)}}">
                                            </div> 

                                            <div class="form-group col-sm-6 col-xs-6">
                                                <label for="lang1_name" class="required">Name (Lang 1)</label>
                                                <input type="text" name="lang1_name" class="form-control" id="lang1_name" placeholder="Enter Complimentary Name (Lang 1)" value="{{old('lang1_name',$result->lang1_name)}}"> 
                                            </div>     
                                        </div>
                                        ...
                                        <div class="row pt-3">
                                            <div class="form-group col-sm-6 col-xs-6">
                                                ...
                                                <textarea class="form-control" name="description" rows="5">{{old('description',$result->description)}}</textarea>
                                            </div>      

                                            <div class="form-group col-sm-6 col-xs-6">
                                                <label for="lang1_description">Description ( Lang 1) </label>
                                                <textarea class="form-control" name="lang1_description" rows="5">{{old('lang1_description',$result->lang1_description)}}</textarea>
                                            </div>      
                                        </div>
                                        ...
                                        <div class="row pt-3">
                                            ...
                                            <div class="form-group col-sm-3 col-xs-3">
                                                ...
                                                <select name="quantity_type" id="quantity_type" class="form-control">
                                                    ...
                                                    <option value="{{$quantity->id}}" {{SELECT($quantity->id,old('qunatity_type',$result->quantity_type_id))}}>{{$quantity->name}}</option>
                                                    @endforeach                
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-3 col-xs-3">
                                        ...
                                        <div class="row">
                                          <img src="{{showDiskImage($result->image_path)}}" class="col-sm-3 col-xs-3"/>
                                        </div>
                                        @endif
