                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form action="{{route('sessionMenus.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row pt-3">
                              <div class="form-group col-sm-4 col-xs-4 datepicker">
                            ...
                            <h5>Items Added</h5>
                            <table class="table table-hover items" id="MyTable">
                              <thead>
                                <tr>
                                  <th>Menu Item</th>
                                  <th>Quantity Type</th>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="max-width:1500px!important;">
        <!-- Modal content-->
