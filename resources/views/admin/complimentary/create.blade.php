        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('items.index')}}">Complimentary</a></li>
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="{{route('complimentary.store')}}" enctype="multipart/form-data" method="post">
                                        {{csrf_field()}}

                                        <div class="row pt-3">
                                            <div class="form-group col-sm-6 col-xs-6">
                                                <label for="name" class="required">Complimentary Name</label>

                                                <input type="text" name="name" class="form-control" id="name" placeholder="Enter Complimentary Name" value="{{old('name')}}">
                                            </div>
